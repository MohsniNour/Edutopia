...
import javafx.collections.ObservableList;
    ...
    public void Modifier(Question t, int id) throws SQLException {
        ...
        String query = "UPDATE `question` SET `question`=?,`proposition1`=?,`proposition2`=?,`proposition3`=?,`proposition4`=? , `id_Exam`=? WHERE `id`=?";
    ...
    public ObservableList<Question> Affichertout() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                list.add(new Question(rs.getInt("id"), rs.getString("question"), rs.getString("proposition1"),rs.getString("proposition2"),rs.getString("proposition3"), rs.getString("proposition4"), rs.getDate("archived_Date"),rs.getInt("id_Exam")));
