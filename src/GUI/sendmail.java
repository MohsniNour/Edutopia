...
public class sendmail {
    ...
    public static void sendmail(String recepient) throws Exception {
         ...
         String login = "aymen.negra@esprit.tn";
        String pass = "11941323";
//        String login = "zizoulouati7@gmail.com";
//        String pass = "sonic2019";
...
//        transport.connect();
    ...
    private static Message prepareMessage(Session session, String login, String recepient) {
        ...
        try {
            ...
            msg.setSubject("Nombre d'abscence (Consulter l'administration) ");
            msg.setText("merci ");
