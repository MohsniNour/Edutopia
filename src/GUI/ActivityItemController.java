...
public class ActivityItemController implements Initializable {
    ...
    private void ListWork_DoneAction(ActionEvent event) {
        ...
        stage.close();
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("List_WorkDone.fxml"));
            stage.setScene(new Scene(loader.load()));
            List_WorkDoneController controller = loader.getController();
    ...
    @FXML
    private void ListWork_DoneRatedAction(ActionEvent event) {
        Work_doneService cs = new Work_doneService();
        Node node = (Node) event.getSource();
        Stage stage = (Stage) node.getScene().getWindow();
        stage.close();
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("List_WorkDoneRated.fxml"));
            stage.setScene(new Scene(loader.load()));
            List_WorkDoneRatedController controller = loader.getController();
            controller.initData(act);
            stage.show();
        } catch (IOException e) {
            System.err.println(String.format("Error: %s", e.getMessage()));
