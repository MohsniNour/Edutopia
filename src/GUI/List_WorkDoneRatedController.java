...
import static GUI.List_WorkDoneController.act;
import static GUI.List_WorkDoneController.current_user;
 ...
 * @author ADMIN
 */
public class List_WorkDoneRatedController implements Initializable {
    ...
    public void showActivities() {
        ...
        works = ws.getRatedWorkDoneListByIdActivity(id_Activity);

        try {
            for (int i = 0; i < works.size(); i++) {
                FXMLLoader fxmlLoader = new FXMLLoader();
                fxmlLoader.setLocation(getClass().getResource("WorkDoneRatedItem.fxml"));
                AnchorPane anchorPane = fxmlLoader.load();
                WorkDoneRatedItemController itemController = fxmlLoader.getController();
