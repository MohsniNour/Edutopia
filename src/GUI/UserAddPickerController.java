 ...
 * @author rayen
 */
public class UserAddPickerController implements Initializable {
 ...
 @FXML
    ...
    @FXML
    private void goto_adminAdd(MouseEvent event) throws IOException {
    ...
    @FXML
    private void goto_teacherAdd(MouseEvent event) throws IOException {
    ...
    @FXML
    private void goto_studentAdd(MouseEvent event) throws IOException {
