 ...
 * @author ADMIN
 */
public class List_Removed_ActivityController implements Initializable {
    ...
    public void showActivities() {
        ...
        acts = as.getArchivedActivitiesListByIdCourse(id_Course);

        try {
            for (int i = 0; i < acts.size(); i++) {
                FXMLLoader fxmlLoader = new FXMLLoader();
                fxmlLoader.setLocation(getClass().getResource("ActivityRemovedItem.fxml"));
                AnchorPane anchorPane = fxmlLoader.load();
                ActivityRemovedItemController itemController = fxmlLoader.getController();
    ...
    private void SearchAction(ActionEvent event) throws SQLException {
        if (txtSearch.getText().isEmpty()) {
            ...
            ActivityService as = new ActivityService();
            List<Activity> acts = new ArrayList<>();
            acts = as.searchRemovedActivity(txtSearch.getText(), id_Course);
    ...
    @FXML
    private void SubjectAction(ActionEvent event) {
    }
